...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? '*𝑺𝒖𝒌𝒖𝒏𝒂-𝑩𝒐𝒕🌴*' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? '𝑺𝒖𝒌𝒖𝒏𝒂🌴' : process.env.OWNER_NAME,
  ...
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? '𝑺𝒖𝒌𝒖𝒏𝒂🌴' : process.env.PACK_INFO.split(";")[1],
